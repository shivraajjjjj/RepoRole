    ...
    <header className="relative flex items-start justify-between gap-4 pb-6 border-b border-slate-800">
      ...
      <div className="flex items-center gap-2 shrink-0 mt-1">
        ...
        <button
          ...
          className="flex items-center gap-2 px-2 py-2 rounded-xl text-sm font-mono font-bold text-slate-950 bg-cyan-400 hover:bg-cyan-300 transition-all duration-200 active:scale-95 shadow-lg shadow-cyan-500/20"
        >
          ↺ Re-analyze
        </button>
      </div>
